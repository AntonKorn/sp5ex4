...
public class TurnstileServer {
    ...
    private static class EchoClientHandler extends Thread {
        ...
        private static void handleClient(Socket socket) throws IOException {
            ...
            while(true){
            pw.println("Are you a turnstile? Write y / n");
            String input = scan.nextLine();
            
            if(input.equalsIgnoreCase("n")){
                
                pw.println("Hi monitor!");
                pw.println("Use show to see the numbers of specatators.");
            ...
            Turnstile turnstile = new Turnstile();
                ...
                pw.println("Write add or show to add or show spectators");
                pw.println("Wtite addnumber to see the spectators yoy have added.");
